    ...
    <div class="row">
      <div class="vw-page-content" role="main" itemprop="articleBody">
        ...
        <article <?php post_class( 'vw-main-post' ); ?>>
          ...
          <?php vw_the_subtitle(); ?>
          <span class="author vcard hidden"><span class="fn"><?php echo esc_attr( get_the_author() ); ?></span></span> <span class="updated hidden"><?php echo esc_attr( get_the_date( 'Y-m-d' ) ); ?></span>
